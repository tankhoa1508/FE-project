      ...
      <div className="container-products">
        <div className="head-product">
            ...
            <select className="sort" name="sort" id="sort">
                ...
                <option value="high-to-low">Thứ tự theo giá: cao xuống thấp</option>
            </select>
            </div>
        </div>
        <Row className="row-products">
            <Col className="col1" md="3">
                ...
                <ul className="product-categories">
                    <li className="li-product border-bottom"><a>Casio</a></li>
                    <li className="li-product border-bottom"><a>Citizen</a></li>
                    <li className="li-product border-bottom"><a>Đồng hồ cặp đôi</a></li>
                    <li className="li-product border-bottom"><a>Đồng hồ nam</a></li>
                    <li className="li-product border-bottom"><a>Đồng hồ nữ</a></li>
                    <li className="li-product border-bottom"><a>ROLEX</a></li>
                    <li className="li-product border-bottom"><a>Sale</a></li>
                    <li className="li-product"><a>Sản phẩm hot</a></li>
                </ul>
            </Col>
